...
public class TreasureHuntActivity extends GvrActivity implements GvrView.StereoRenderer {
  ...
  WebSocket ws;
  ////////////////This part from Websocket communication///////////////////////
  private OkHttpClient client;
  private final class EchoWebSocketListener extends WebSocketListener {
    private static final int NORMAL_CLOSURE_STATUS = 1000;
    @Override
    public void onOpen(WebSocket webSocket, Response response) {
      webSocket.send("Hello, it's HITLAB !");
      webSocket.send("What's up ?");
      ws = webSocket;
      ws.send("Message from an new websocket intance");
    ...
    public void onMessage(WebSocket webSocket, String text) {
      ...
      //Toast.makeText(TreasureHuntActivity.this.getApplicationContext(), text, Toast.LENGTH_LONG).show();
      Log.e(TAG, "Message from server //////////////////////////////////////////////////////////////////////////////" + text);
    }
    @Override
  ...
  ////////////////This part from serial control///////////////////////

  public final String ACTION_USB_PERMISSION = "com.google.vr.sdk.samples.treasurehunt.USB_PERMISSION";
        ...
        if (!usbDevices.isEmpty()) {
          ...
          for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
            ...
            if (deviceVID == 0x0403)//Arduino Vendor ID
            {
              ...
              PendingIntent pi = PendingIntent.getBroadcast(TreasureHuntActivity.this, 0, new Intent(ACTION_USB_PERMISSION), 0);
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    //JAM IN CODE///////////////////////////////////////////////////
    /////////////To start the websocket comm with server////////////
  ...
  public void onCardboardTrigger() {
    ...
    if (isLookingAtObject()) {
      //JAM IN THE EFFECT FOR DYNAMIC IMMERSION
      if(ws != null) {
        FadingEffectOn();
      }
      /*
  ...
  */
      ...
      System.out.println("YOU PRESSED ON THE SCREEN!!!!!!!!!!!");
  ...
  void Ultilities(){
    ...
    ///Want to send data
    //Possible to send values from 0 to 4 as level of opacity
    //0 for transparent and 4 for complete darkness.
    String string = "0";
    serialPort.write(string.getBytes());
  ...
  ///////////////////////////////////////////////////////////////////
  /*
  private void StartUSBManagement(final String txt) {
    runOnUiThread(new Runnable() {
      @Override
      public void run() {
        try {
  ...
  */
    ...
    runOnUiThread(new Runnable() {
      ...
      public void run() {
        try {
          ...
          String string = "1";
          serialPort.write(string.getBytes());
          ws.send("A"+string); //Move ws as global scope and send simple format from client
          Thread.sleep(1500);
          string = "2";
          serialPort.write(string.getBytes());
          ws.send("A"+string); //Move ws as global scope and send simple format from client
  ...
  ///////////////WEBSOCKET PART//////////////////////////////////
  private void StartWebsocketComm() {
    runOnUiThread(new Runnable() {
      @Override
      public void run() {
        //Request request = new Request.Builder().url("ws://echo.websocket.org").build();
        //Request request = new Request.Builder().url("ws://demos.kaazing.com/echo").build();
        Request request = new Request.Builder().url("ws://10.32.51.35:3000/ws/websocket").build();
  ...
  //////////////////////////////////////////////////////////////
  //////////Code for better manage activity life circle////////
  ...
  protected void onStop() {
    ...
    ws.send("Section closing signal from Treasuer App");
  }
  @Override
